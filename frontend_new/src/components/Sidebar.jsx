...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      >
        <Link to="/" className="flex items-center gap-2 font-bold text-white" aria-label="VidhanAI Home">
          <span className="icon-chip icon-purple" style={{ width: 32, height: 32, fontSize: '1rem' }}>⚖️</span>
          Vidhan<span style={{ color: '#818cf8' }}>AI</span>
        </Link>
        <button
          type="button"
      ...
      <aside className="sidebar hidden lg:flex" aria-label="Main navigation">
        <Link to="/" className="flex items-center gap-2.5 px-2 pb-5" aria-label="VidhanAI Home">
          <span className="icon-chip icon-purple" style={{ width: 36, height: 36, fontSize: '1.1rem' }}>⚖️</span>
